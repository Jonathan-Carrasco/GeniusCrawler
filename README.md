...
# File Summary
The unfiltered csv file contains the 15 most frequent words of all songs, including stopwords while the filtered csv file contains the 15 most frequent words excluding stopwords.
